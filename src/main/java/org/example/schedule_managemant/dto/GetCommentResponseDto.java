...
public class GetCommentResponseDto {
    ...
    private final String cm_contents;
    private final String cm_name;
    private final LocalDateTime cm_created;
    private final LocalDateTime cm_modified;

    public GetCommentResponseDto(Long cm_id, String cm_contents, String cm_name, LocalDateTime cm_created, LocalDateTime cm_modified) {
        this.cm_id = cm_id;
